				...
				<div class="footer-bottom__wrap">
					...
					<div class="footer-bottom__right">
						<div class="footer-bottom__btns">
							<a class="btn btn--white" href="/jahorina/kontakt/">Zakaži prezentaciju</a>
							<a class="btn opacity btn--white" href="javascript:;">Preuzmi Brošuru</a>
						</div>
					</div>
				</div>
