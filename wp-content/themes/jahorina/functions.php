...
function enqueue_gsap_scripts() {
    // Uključi GSAP (možeš koristiti lokalni fajl ili CDN)
    // wp_enqueue_script(
    //     'gsap',
    //     'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js', // CDN verzija
    //     array(),
    //     '3.12.2',
    //     true
    // );

    // Uključi SplitText iz lokalnog foldera
    wp_enqueue_script(
        'split-text',
        get_template_directory_uri() . '/assets/js/vendor/SplitText.min.js',
        array('gsap'), // SplitText zavisi od GSAP-a
        null,
        true
    );
}
